...
//ini_set("SMTP","kbrinfo@kbrinfra.com"); //mail server 
//ini_set("smtp_port","25");
//echo $sql;


 $to        = 'kbrinfo@kbrinfra.com';
 //$to        = 'kbrinfo@kbrinfra.com, ';
...
";
  ...
  $headers  = 'From:kbrinfo@kbrinfra.com' . "\r\n" .
          'Reply-To:kbrinfo@kbrinfra.com' . "\r\n" .
		  'Content-Type: text/html' . "\r\n" .
          'X-Mailer: PHP/' . phpversion();
     //echo $to.'<br>'.$subject.'<br>'.$message.'<br>'.$headers;
  //ini_set ("smtp_port","25");
  $success =" ";
 // ini_set ("sendmail_from","kbrinfo@kbrinfra.com ");
