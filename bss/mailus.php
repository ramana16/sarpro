...
//ini_set("SMTP","enquiry@bssassociates.com"); //mail server 
//ini_set("smtp_port","25");
//echo $sql;


 $to        = 'enquiry@bssassociates.com';
 //$to        = 'enquiry@bssassociates.com, ';
...
";
  ...
  $headers  = 'From:enquiry@bssassociates.com' . "\r\n" .
          'Reply-To:enquiry@bssassociates.com' . "\r\n" .
		  'Content-Type: text/html' . "\r\n" .
          'X-Mailer: PHP/' . phpversion();
     //echo $to.'<br>'.$subject.'<br>'.$message.'<br>'.$headers;
  //ini_set ("smtp_port","25");
  $success =" ";
 // ini_set ("sendmail_from","enquiry@bssassociates.com ");
