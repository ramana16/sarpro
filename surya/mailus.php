...
//ini_set("SMTP","enquiry@suryamarketingagencies.com"); //mail server 
//ini_set("smtp_port","25");
//echo $sql;


 $to        = 'enquiry@suryamarketingagencies.com';
 //$to        = 'enquiry@suryamarketingagencies.com ';
...
";
  ...
  $headers  = 'From:enquiry@suryamarketingagencies.com' . "\r\n" .
          'Reply-To:enquiry@suryamarketingagencies.com' . "\r\n" .
		  'Content-Type: text/html' . "\r\n" .
          'X-Mailer: PHP/' . phpversion();
     //echo $to.'<br>'.$subject.'<br>'.$message.'<br>'.$headers;
  //ini_set ("smtp_port","25");
  $success =" ";
 // ini_set ("sendmail_from","enquiry@suryamarketingagencies.com ");
...
<tr>
        ...
        -->
<script>self.location='thankyou.html';</script>