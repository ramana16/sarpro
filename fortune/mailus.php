...
//ini_set("SMTP","fortuneint2011@gmail.com"); //mail server 
//ini_set("smtp_port","25");
//echo $sql;


 $to        = 'fortuneint2011@gmail.com';
 //$to        = 'fortuneint2011@gmail.com, ';
...
";
  ...
  $headers  = 'From:fortuneint2011@gmail.com' . "\r\n" .
          'Reply-To:fortuneint2011@gmail.com' . "\r\n" .
		  'Content-Type: text/html' . "\r\n" .
          'X-Mailer: PHP/' . phpversion();
     //echo $to.'<br>'.$subject.'<br>'.$message.'<br>'.$headers;
  //ini_set ("smtp_port","25");
  $success =" ";
 // ini_set ("sendmail_from","fortuneint2011@gmail.com ");
